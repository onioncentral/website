...
Long-form marketing/sales page for Digital ONION® (onioncentral.com). Pure HTML5/CSS3 with zero JavaScript dependencies. Deployed via GitHub Pages.
...
- **CNAME** — Custom domain mapping to `onioncentral.com`
